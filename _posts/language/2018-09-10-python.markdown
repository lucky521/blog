...
如果安装时报"ERROR: Could not install packages due to an OSError: [Errno 28] No space left on device"
TMPDIR=/xxx pip install torch --cache-dir=/xxx
