...
## 健康检查策略
https://github.com/apache/brpc/blob/master/docs/cn/load_balancing.md#%E5%81%A5%E5%BA%B7%E6%A3%80%E6%9F%A5
/health 健康健康接口到底是让谁调用的？ 在brpc源码里并没有它的调用之处。


## 请求录制
rpc_dump_dir， 默认放置在./rpc_data/rpc_dump/<app>
